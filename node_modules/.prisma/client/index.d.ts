...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> = {
    ...
    meta: {
      modelProps: "user_sequences" | "chats" | "chat_messages" | "global_chats" | "global_chat_messages" | "settings" | "users" | "bookmarks" | "chess_games"
    ...
    model: {
      ...
      chess_games: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.chess_gamesFindRawArgs<ExtArgs>
            result: JsonObject
          }
          aggregateRaw: {
            args: Prisma.chess_gamesAggregateRawArgs<ExtArgs>
            result: JsonObject
          }
          count: {
  ...
  export type Chess_gamesCountAggregateOutputType = {
    ...
    whitePlayerName: number
    blackPlayerId: number
    blackPlayerName: number
    isAiGame: number
    board: number
    currentTurn: number
    moves: number
  ...
  export type chess_gamesSelect<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetSelect<{
    ...
    whitePlayerName?: boolean
    blackPlayerId?: boolean
    blackPlayerName?: boolean
    isAiGame?: boolean
    board?: boolean
    currentTurn?: boolean
    moves?: boolean
  ...
  export type chess_gamesOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "guildId" | "channelId" | "whitePlayerId" | "whitePlayerName" | "blackPlayerId" | "blackPlayerName" | "isAiGame" | "board" | "currentTurn" | "moves" | "status" | "winner" | "createdAt" | "updatedAt", ExtArgs["result"]["chess_games"]>
  ...
  export interface chess_gamesDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    ...
    /**
     * Find zero or more Chess_games that matches the filter.
     * @param {chess_gamesFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const chess_games = await prisma.chess_games.findRaw({
     *   filter: { age: { $gt: 25 } }
     * })
     */
    findRaw(args?: chess_gamesFindRawArgs): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a Chess_games.
     * @param {chess_gamesAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const chess_games = await prisma.chess_games.aggregateRaw({
     *   pipeline: [
     *     { $match: { status: "registered" } },
     *     { $group: { _id: "$country", total: { $sum: 1 } } }
     *   ]
     * })
     */
    aggregateRaw(args?: chess_gamesAggregateRawArgs): Prisma.PrismaPromise<JsonObject>
  ...
  interface chess_gamesFieldRefs {
    readonly id: FieldRef<"chess_games", 'String'>
    readonly guildId: FieldRef<"chess_games", 'String'>
    readonly channelId: FieldRef<"chess_games", 'String'>
    readonly whitePlayerId: FieldRef<"chess_games", 'String'>
    readonly whitePlayerName: FieldRef<"chess_games", 'String'>
    readonly blackPlayerId: FieldRef<"chess_games", 'String'>
    readonly blackPlayerName: FieldRef<"chess_games", 'String'>
    readonly isAiGame: FieldRef<"chess_games", 'Boolean'>
    readonly board: FieldRef<"chess_games", 'String'>
    readonly currentTurn: FieldRef<"chess_games", 'String'>
    readonly moves: FieldRef<"chess_games", 'String[]'>
    readonly status: FieldRef<"chess_games", 'String'>
    readonly winner: FieldRef<"chess_games", 'String'>
    readonly createdAt: FieldRef<"chess_games", 'DateTime'>
    readonly updatedAt: FieldRef<"chess_games", 'DateTime'>
  }
   ...
   * chess_games findRaw
   */
  export type chess_gamesFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * The query predicate filter. If unspecified, then all documents in the collection will match the predicate. ${@link https://docs.mongodb.com/manual/reference/operator/query MongoDB Docs}.
     */
    filter?: InputJsonValue
  ...
  /**
   * chess_games aggregateRaw
   */
  export type chess_gamesAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * An array of aggregation stages to process and transform the document stream via the aggregation pipeline. ${@link https://docs.mongodb.com/manual/reference/operator/aggregation-pipeline MongoDB Docs}.
     */
    pipeline?: InputJsonValue[]
  ...
  export type chess_gamesWhereInput = {
    ...
    id?: StringFilter<"chess_games"> | string
    guildId?: StringFilter<"chess_games"> | string
    channelId?: StringFilter<"chess_games"> | string
    whitePlayerId?: StringFilter<"chess_games"> | string
    whitePlayerName?: StringFilter<"chess_games"> | string
    blackPlayerId?: StringFilter<"chess_games"> | string
    blackPlayerName?: StringFilter<"chess_games"> | string
    isAiGame?: BoolFilter<"chess_games"> | boolean
    board?: StringFilter<"chess_games"> | string
    currentTurn?: StringFilter<"chess_games"> | string
    moves?: StringNullableListFilter<"chess_games">
    status?: StringFilter<"chess_games"> | string
    winner?: StringNullableFilter<"chess_games"> | string | null
    createdAt?: DateTimeFilter<"chess_games"> | Date | string
    updatedAt?: DateTimeFilter<"chess_games"> | Date | string
  }
  ...
  export type chess_gamesOrderByWithRelationInput = {
    ...
    whitePlayerName?: SortOrder
    blackPlayerId?: SortOrder
    blackPlayerName?: SortOrder
    isAiGame?: SortOrder
    board?: SortOrder
  ...
  export type chess_gamesScalarWhereWithAggregatesInput = {
    ...
    id?: StringWithAggregatesFilter<"chess_games"> | string
    guildId?: StringWithAggregatesFilter<"chess_games"> | string
    channelId?: StringWithAggregatesFilter<"chess_games"> | string
    whitePlayerId?: StringWithAggregatesFilter<"chess_games"> | string
    whitePlayerName?: StringWithAggregatesFilter<"chess_games"> | string
    blackPlayerId?: StringWithAggregatesFilter<"chess_games"> | string
    blackPlayerName?: StringWithAggregatesFilter<"chess_games"> | string
    isAiGame?: BoolWithAggregatesFilter<"chess_games"> | boolean
    board?: StringWithAggregatesFilter<"chess_games"> | string
    currentTurn?: StringWithAggregatesFilter<"chess_games"> | string
    moves?: StringNullableListFilter<"chess_games">
    status?: StringWithAggregatesFilter<"chess_games"> | string
    winner?: StringNullableWithAggregatesFilter<"chess_games"> | string | null
    createdAt?: DateTimeWithAggregatesFilter<"chess_games"> | Date | string
    updatedAt?: DateTimeWithAggregatesFilter<"chess_games"> | Date | string
  }
  ...
  export type chess_gamesCreateInput = {
    ...
    board: string
    currentTurn?: string
    moves?: chess_gamesCreatemovesInput | string[]
    status?: string
    winner?: string | null
    createdAt?: Date | string
  ...
  export type chess_gamesUpdateInput = {
    ...
    whitePlayerName?: StringFieldUpdateOperationsInput | string
    blackPlayerId?: StringFieldUpdateOperationsInput | string
    blackPlayerName?: StringFieldUpdateOperationsInput | string
    ...
    moves?: chess_gamesUpdatemovesInput | string[]
    status?: StringFieldUpdateOperationsInput | string
  ...
  export type chess_gamesCreatemovesInput = {
    set: string[]
  }
  ...
  export type chess_gamesUpdatemovesInput = {
    set?: string[]
    push?: string | string[]
  }
